...
export default function SubmitToolGuidePage() {
  return (
    <DocPage
      ...
      description="Learn how to submit your developer tool to DevHunt, from preparation to publication."
    >
      <div className="space-y-8">
        ...
        {/* Preparation */}
        <section className="space-y-4">
          <h2 id="preparation" className="text-2xl font-bold tracking-tight scroll-mt-20">Preparation</h2>
        ...
        {/* Submission Process */}
        <section className="space-y-4">
          <h2 id="submission-process" className="text-2xl font-bold tracking-tight scroll-mt-20">Submission Process</h2>
        ...
        {/* Requirements */}
        <section className="space-y-4">
          <h2 id="requirements" className="text-2xl font-bold tracking-tight scroll-mt-20">Requirements</h2>
        ...
        {/* After Submission */}
        <section className="space-y-4">
          <h2 id="after-submission" className="text-2xl font-bold tracking-tight scroll-mt-20">After Submission</h2>
