...
export default function ApiGuidePage() {
  return (
    <DocPage
      title="Using the DevHunt API"
      description="Integrate DevHunt data into your applications using our comprehensive API."
    >
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex p-4 bg-primary/5 rounded-lg">
        ...
        {/* Getting Started */}
        <section className="space-y-4">
          <h2 id="getting-started" className="text-2xl font-bold tracking-tight scroll-mt-20">Getting Started</h2>
          ...
          <div className="bg-muted p-4 rounded-md overflow-x-auto my-6">
...
curl -X GET "https://api.devhunt.io/v1/tools" \\
  -H "Authorization: Bearer YOUR_API_KEY"`}</code></pre>
        ...
        {/* Authentication */}
        <section className="space-y-4">
          <h2 id="authentication" className="text-2xl font-bold tracking-tight scroll-mt-20">Authentication</h2>
        ...
        {/* API Endpoints */}
        <section className="space-y-4">
          <h2 id="endpoints" className="text-2xl font-bold tracking-tight scroll-mt-20">API Endpoints</h2>
  ...
  "meta": {
    ...
    "total_pages": 46
        ...
        {/* Rate Limits */}
        <section className="space-y-4">
          <h2 id="rate-limits" className="text-2xl font-bold tracking-tight scroll-mt-20">Rate Limits</h2>
...
X-RateLimit-Reset: 1628607246`}</code></pre>
          ...
          <div className="flex p-4 bg-yellow-50 dark:bg-yellow-950 border border-yellow-200 dark:border-yellow-900 rounded-lg">
...
const jsTools = await fetch(
  '/v1/tools?tag=javascript'
          ...
          <div className="relative my-6 p-6 bg-primary/5 rounded-lg">
